...
RunConfiguration.setExecutionSettingFile('C:\\Users\\user\\AppData\\Local\\Temp\\Katalon\\Test Cases\\GoAML Report 1\\20200827_112651\\execution.properties')
...
not_run: WebUI.setText(findTestObject('All/UserName'), 'anggi1')

not_run: WebUI.setEncryptedText(findTestObject('All/password'), 'iFGeFYmXIrWy72D5I5E8Dw==')
...
not_run: WebUI.callTestCase(findTestCase('Identitas Orang Mewakili Transaksi'), [:], FailureHandling.STOP_ON_FAILURE)
