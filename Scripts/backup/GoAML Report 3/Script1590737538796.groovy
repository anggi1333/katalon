...
for (def rowNum = 1; rowNum <= findTestData('GoAMLReport/Transaksi').getRowNumbers(); rowNum++) {
    ...
    if (findTestData('GoAMLReport/Transaksi').getValue(1, rowNum) == 'true') {
        ...
        if (findTestData('GoAMLReport/Transaksi').getValue(8, rowNum) == 'person') {
            ...
            WebUI.setText(findTestObject('GoAmlReport/05 Person/Person From/01 Jenis Kelamin'), 'L - Laki-laki')
        ...
        if (findTestData('GoAMLReport/Transaksi').getValue(8, rowNum) == 'entity') {
            ...
            WebUI.setText(findTestObject('GoAmlReport/07 Entity/Account Tab From/03 Director/01 Jenis Kelamin'), 'peremp')
        ...
        if (findTestData('GoAMLReport/Transaksi').getValue(11, rowNum) == 'person') {
            ...
            WebUI.setText(findTestObject('GoAmlReport/05 Person/Person To/01 Jenis Kelamin'), 'L - Laki-laki')
            ...
            WebUI.setText(findTestObject('GoAmlReport/05 Person/Person To/06 Nama Ibu Kandung'), '31333')
            ...
            WebUI.scrollToElement(findTestObject('GoAmlReport/05 Person/Person To/12 Pekerjaan'), 3)
            ...
            WebUI.sendKeys(findTestObject('GoAmlReport/05 Person/Person Tab To/01 Telepon/01 Kategori Kontak'), Keys.chord(
                    Keys.ENTER))
            ...
            WebUI.sendKeys(findTestObject('GoAmlReport/05 Person/Person Tab To/01 Telepon/02 Alat Komunikasi'), Keys.chord(
                    Keys.ENTER))
            ...
            WebUI.setText(findTestObject('GoAmlReport/05 Person/Person Tab To/03 Alamat Tempat Bekerja/01 Type Alamat'), 
                'K - Kantor')

            WebUI.delay(3)

            WebUI.sendKeys(findTestObject('GoAmlReport/05 Person/Person Tab To/03 Alamat Tempat Bekerja/01 Type Alamat'), 
                Keys.chord(Keys.ENTER))
            ...
            WebUI.setText(findTestObject('GoAmlReport/05 Person/Person Tab To/05 Dokumen Identitas/03 Negara Penerbit'), 
                'ID - INDONESIA')

            WebUI.delay(3)

            WebUI.sendKeys(findTestObject('GoAmlReport/05 Person/Person Tab To/05 Dokumen Identitas/03 Negara Penerbit'), 
                Keys.chord(Keys.ENTER))
