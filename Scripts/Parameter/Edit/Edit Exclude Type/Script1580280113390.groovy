...
WebUI.setText(findTestObject('All/filter'), 'Exclude Type')
...
for (def rowNum = 1; rowNum <= findTestData('Parameter/Exclude Type Add').getRowNumbers(); rowNum++) {
    WebUI.click(findTestObject('All/New Record'))

    WebUI.delay(2)

    WebUI.setText(findTestObject('Parameter/Text 1 Exclude Type'), findTestData('Parameter/Exclude Type Add').getValue(1, 
            rowNum))

    WebUI.setText(findTestObject('Parameter/Text 2 Exclude Type'), findTestData('Parameter/Exclude Type Add').getValue(2, 
            rowNum))
